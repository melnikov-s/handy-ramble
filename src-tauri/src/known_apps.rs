...
pub fn get_known_applications() -> Vec<KnownApp> {
    vec![
        ...
        KnownApp {
            ...
            suggested_category: "medium".to_string(),
        },
        KnownApp {
        ...
        KnownApp {
            ...
            suggested_category: "low".to_string(),
        },
        KnownApp {
        ...
        KnownApp {
            ...
            suggested_category: "high".to_string(),
        },
        KnownApp {
...
mod tests {
    ...
    fn test_get_known_applications() {
        ...
        assert_eq!(vscode.unwrap().suggested_category, "medium");
    }
    ...
    fn test_find_known_app() {
        ...
        assert_eq!(slack.unwrap().suggested_category, "low");
